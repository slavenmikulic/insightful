...
describe('Employee Statistic Utils', () => {
  ...
  it('should calculate shift statistics for an employee with one shift within the same day', () => {
    ...
    expect(result).toEqual({
      ...
      overtimeAmount: 0,
      workDays: [new Date(2023, 0, 1, 0, 0, 0, 0)]
    });
  });
  ...
  it('should calculate shift statistics for an employee with overtime', () => {
    employee.shifts = [
      {
        ...
        clockOut: new Date(1704132000000) // '2023-01-01T18:00:00'
      }
    ];
    ...
    expect(result).toEqual({
      ...
      workDays: [new Date(2024, 0, 1, 0, 0, 0)]
    });
  });

  it('should calculate shift statistics for an employee with one shift spanning two days', () => {
    const clockIn = new Date(1704146400000); // '2024-01-01T22:00:00'
    const clockOut = new Date(1704175200000); // '2024-01-02T06:00:00'
    ...
    expect(result).toEqual({
      ...
      overtimeAmount: 0,
      workDays: [new Date(2024, 0, 1, 0, 0, 0), new Date(2024, 0, 2, 0, 0, 0)]
    });
  });
  ...
  it('should calculate shift statistics for an employee with multiple shifts', () => {
    ...
    expect(result).toEqual({
      ...
      overtimeAmount: 0,
      workDays: [new Date(2023, 0, 1, 0, 0, 0), new Date(2023, 0, 2, 0, 0, 0), new Date(2023, 0, 3, 0, 0, 0)]
    });
  });
  ...
  it('should calculate shift statistics for an employee with multiple shifts and overtime', () => {
    ...
    employee.shifts = [
      {
        ...
        employeeId: '1',
        clockIn: new Date('2023-01-01T08:00:00'),
        clockOut: new Date('2023-01-01T18:00:00')
      },
      {
        id: '2',
        employeeId: '1',
    ...
    expect(result).toEqual({
      ...
      workDays: [new Date(2023, 0, 1, 0, 0, 0), new Date(2023, 0, 2, 0, 0, 0)]
    });
  });
});
